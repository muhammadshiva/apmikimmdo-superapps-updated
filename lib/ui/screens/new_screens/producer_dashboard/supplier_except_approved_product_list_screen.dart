                    ...
                    SliverAppBar(
                      // elevation: 2.5,
                        ...
                        bottom: PreferredSize(
                            ...
                            preferredSize:
                            Size.fromHeight(kToolbarHeight + 65))),
                  ],
...
class _ImageWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return kIsWeb
        ? Image.network(
      "${AppConst.STORAGE_URL}/products/${product.productAssets[0].image}",
      // "",
      width: 60,
      height: 60,
      fit: BoxFit.cover,
      ...
      imageUrl: product.productAssets[1].image,
      memCacheHeight:
