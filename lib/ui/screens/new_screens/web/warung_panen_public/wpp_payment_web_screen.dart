...
class WppPaymentWebScreen extends StatefulWidget {
  const WppPaymentWebScreen({Key key, this.checkoutTemp}) : super(key: key);

  final WppCheckoutTempWeb checkoutTemp;

  @override
  _WppPaymentWebScreenState createState() => _WppPaymentWebScreenState();
}

class _WppPaymentWebScreenState extends State<WppPaymentWebScreen> {
              ...
              listener: (context, state) {
                if (state is AddOrderSuccess) {
                  ...
                  WppInvoice wppInvoice = WppInvoice(
                      order: state.data, checkout: widget.checkoutTemp);
                  context.beamToNamed(
                      '/wpp/paymentdetail?dt=${AppExt.encryptMyData(jsonEncode(wppInvoice))}');
                }
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    ListView.separated(
                                      ...
                                      itemCount:
                                          widget.checkoutTemp.cart.length,
