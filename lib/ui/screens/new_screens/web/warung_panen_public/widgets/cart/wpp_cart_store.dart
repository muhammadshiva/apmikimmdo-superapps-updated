...
import 'package:marketplace/ui/screens/new_screens/web/warung_panen_public/widgets/cart/wpp_cart_store_item.dart';
import 'package:marketplace/utils/extensions.dart' as AppExt;
import 'package:marketplace/utils/typography.dart' as AppTypo;

class WppCartStore extends StatelessWidget {
  const WppCartStore({
    Key key,
            ...
            children: [
              for (var p = 0; p < cart.length; p++)
                WppCartStoreItem(
                  ...
                  image: cart[p].product.productPhoto[0].image,
                  nama: cart[p].product.name,
                  harga: cart[p].product.disc > 0 ? cart[p].product.discPrice : cart[p].product.sellingPrice,
                ),
            ],
          ),
          Divider(
